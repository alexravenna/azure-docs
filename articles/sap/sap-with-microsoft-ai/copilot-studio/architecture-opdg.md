...
![Architecture - On-Premises Data Gateway](./apim-cloud-connector-opdg.jpg)
...
* [Set up Microsoft Entra ID with Kerberos for SSO](https://learn.microsoft.com/power-platform/sap/connect/entra-id-kerberos)
* [Set up Microsoft Entra ID with certificates for SSO](https://learn.microsoft.com/power-platform/sap/connect/entra-id-certs)
