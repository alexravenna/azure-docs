...
# Leveraging Azure API Management and vnet Peering (for example, SAP S/4HANA Private Cloud or Native)
...
* [Set up Microsoft Entra ID, Azure API Management, and SAP for SSO from SAP OData connector](https://learn.microsoft.com/power-platform/sap/connect/entra-id-apim-oauth)
...
* [Quickstart: Create a new Azure API Management instance by using the Azure portal](https://learn.microsoft.com/azure/api-management/get-started-create-service-instance)
* [Use a virtual network to secure inbound or outbound traffic for Azure API Management](https://learn.microsoft.com/azure/api-management/virtual-network-concepts#virtual-network-injection-classic-tiers)
* [Azure virtual network peering](https://learn.microsoft.com/azure/virtual-network/virtual-network-peering-overview)
* [Connectivity with SAP RISE](https://learn.microsoft.com/azure/sap/workloads/rise-integration-network)
...
* [Microsoft 365 Agents Toolkit - Add cloud resources and API connection](https://learn.microsoft.com/microsoftteams/platform/toolkit/add-resource)
...
* [Define APIs](https://learn.microsoft.com/azure/api-management/add-api-manually)
