...
Azure IoT Operations (AIO) offers two built-in roles designed to simplify and secure access management for AIO resources: [Azure IoT Operations Administrator](/azure/role-based-access-control/built-in-roles/internet-of-things#azure-iot-operations-administrator) and [Azure IoT Operations Onboarding](/azure/role-based-access-control/built-in-roles/internet-of-things#azure-iot-operations-administrator). If your scenario requires more granular access, you can [create a custom RBAC role](../reference/custom-rbac.md).
