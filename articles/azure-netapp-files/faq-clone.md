...
Regular clones occupy the same capacity pool space as the source volume. They can exist for as long as they are needed. To create a volume clone, select the volume and open the snapshots view under **Storage** Service. Using the Actions (three dots) click **Restore to new volume**. 
