...
1. Check the trigger's outputs, if any, to confirm that they appear as you expect. On the **History** pane, under **Outputs link**, select the link, which shows the **Outputs** pane.
   ...
   :::image type="content" source="media/logic-apps-diagnosing-failures/review-trigger-outputs-consumption.png" alt-text="Screenshot showing Consumption logic app workflow trigger outputs." lightbox="media/logic-apps-diagnosing-failures/review-trigger-outputs-consumption.png":::
...
1. Check the trigger's outputs, if any, to confirm that they appear as you expect. On the **History** pane, under **Outputs link**, select the link, which shows the **Outputs** pane.
   ...
   :::image type="content" source="media/logic-apps-diagnosing-failures/review-trigger-outputs-standard.png" alt-text="Screenshot showing Standard logic app workflow trigger outputs." lightbox="media/logic-apps-diagnosing-failures/review-trigger-outputs-standard.png":::
...
1. After all the steps in the run appear, select each step to expand their shapes.
   ...
   :::image type="content" source="media/logic-apps-diagnosing-failures/logic-app-run-pane-consumption.png" alt-text="Screenshot showing Consumption logic app workflow with failed step selected." lightbox="media/logic-apps-diagnosing-failures/logic-app-run-pane-consumption.png":::

1. Review the inputs, outputs, and any error messages for the failed step.

   :::image type="content" source="media/logic-apps-diagnosing-failures/failed-action-inputs-consumption.png" alt-text="Screenshot showing Consumption logic app workflow with failed step details." lightbox="media/logic-apps-diagnosing-failures/failed-action-inputs-consumption.png":::

   For example, the following screenshot shows the outputs from the failed RSS action.

   :::image type="content" source="media/logic-apps-diagnosing-failures/failed-action-outputs-consumption.png" alt-text="Screenshot showing Consumption logic app workflow with failed step outputs." lightbox="media/logic-apps-diagnosing-failures/failed-action-outputs-consumption.png":::
...
1. After all the steps in the run appear, select each step to review their details.
   ...
   :::image type="content" source="media/logic-apps-diagnosing-failures/logic-app-run-pane-standard.png" alt-text="Screenshot showing Standard logic app workflow with failed step selected." lightbox="media/logic-apps-diagnosing-failures/logic-app-run-pane-standard.png":::

1. Review the inputs, outputs, and any error messages for the failed step.

   :::image type="content" source="media/logic-apps-diagnosing-failures/failed-action-inputs-standard.png" alt-text="Screenshot showing Standard logic app workflow with failed step inputs." lightbox="media/logic-apps-diagnosing-failures/failed-action-inputs-standard.png":::

   For example, the following screenshot shows the outputs from the failed RSS action.

   :::image type="content" source="media/logic-apps-diagnosing-failures/failed-action-outputs-standard.png" alt-text="Screenshot showing Standard logic app workflow with failed step outputs." lightbox="media/logic-apps-diagnosing-failures/failed-action-outputs-standard.png":::
...
* No service-level agreement (SLA) guarantee exists for latency.
...
* [Check workflow status, view run history, and set up alerts in Azure Logic Apps](view-workflow-status-run-history.md)
