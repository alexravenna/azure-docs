...
Options for your new storage account are organized into tabs in the **Create a storage account** page. The following image shows these tabs.
...
The following image shows the options that appear in the **Basics** tab:
...
The following image shows the options that appear in the **Advanced** tab:

:::image type="content" source="media/storage-account-create/create-account-advanced-tab.png" alt-text="Screenshot that shows options in the Advanced tab.":::
...
| Blob storage      | Enable SFTP                           | Optional             | Enable the use of Secure File Transfer Protocol (SFTP) to securely transfer of data over the internet. For more information, see [Secure File Transfer (SFTP) protocol support in Azure Blob Storage](../blobs/secure-file-transfer-protocol-support.                                                                                                                                                                |
...
| Azure Files       | Enable Managed Identity for SMB       | Optional             | This setting enables secure, credential-free access to Azure SMB file shares by allowing authentication through Microsoft Entra ID instead of storage account keys. This approach strengthens security and eliminates the need for storage account key access for VM and appplication. See [Access SMB Azure file shares by using managed identities with Microsoft Entra ID](../files/files-managed-identities.md). |
...
The following image shows the options that appear in the **Networking** tab:

:::image type="content" source="media/storage-account-create/create-account-network-tab.png" alt-text="Screenshot that shows options in the Networking tab.":::

The following table describes the fields on the **Networking** tab.

| Field                        | Required or optional | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|------------------------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Public network access        | Required             | This setting specifies the default public network access rule. You enable inbound traffic, block all traffic or secure traffic by using a network security perimeter. If you choose to enable traffic, you can apply more granular control by using the options available in the **Public network access scope** section of this page.                                                                                                                            |
| Public network access scope  | Required             | If you enable public network access, then you can enable inbound traffic from all networks or allow traffic only from specific virtual networks or IP address ranges.                                                                                                                                                                                                                                                                                             |
| Virtual network subscription | Optional             | If you choose to enable inbound traffic only from specific virtual networks or IP address ranges, you can use this setting to specify the subscription of a virtual network to which you would like allow traffic.                                                                                                                                                                                                                                                |
| Virtual network              | Optional             | If you choose to enable inbound traffic only from specific virtual networks or IP address ranges, you can use this setting to specify the name of a virtual network from which you would like to allow traffic.                                                                                                                                                                                                                                                   |
| IPv4 Addresses               | Optional             | If you choose to enable inbound traffic only from specific virtual networks or IP address ranges, then you can use this setting to select public internet IP addresses from which you would like to allow traffic.                                                                                                                                                                                                                                                |
...
The following image shows the options that appear in the **Data protection** tab:

:::image type="content" source="media/storage-account-create/create-account-data-protection-tab.png" alt-text="Screenshot that shows options in the Data protection tab.":::
...
The following image shows the options that appear in the **Security** tab:

:::image type="content" source="media/storage-account-create/create-account-security-tab.png" alt-text="Screenshot that shows options in the Security tab.":::
...
The following image shows the options that appear in the **Encryption** tab:
