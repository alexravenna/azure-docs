...
For example, if you're deploying your log management server on an Azure VMware Solution private cloud, you'll need an Azure Virtual Network that can be peered to the private cloud's network.
