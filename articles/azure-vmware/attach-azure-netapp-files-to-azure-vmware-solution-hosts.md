...
As of May 2026, new and existing regular Azure NetApp Files datastores (regular Azure NetApp Files volumes are smaller than 100 TiB) support file sizes larger of up to 64 TiB. This enables large workloads to migrate to Azure VMware Solution. You can identify the maximum file and maximum virtual machine disks size on your Azure NetApp Files datastore by looking at datastore properties in the vSphere Client in the Azure VMware Solution private cloud. The newly mounted Azure NetApp Files datastores will show a maximum file size of 64 TiB and a maximum virtual machine disk size of 62 TiB.
