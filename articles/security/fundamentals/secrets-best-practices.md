...
- Azure Center for SAP solutions: [Azure Center for SAP Solutions - Deployment - Prepare network for deployment](../../sap/center-sap-solutions/prepare-network.md#allowlist-key-vault)
...
- Backup: [Configure a vault to encrypt using customer-managed keys](../../backup/encryption-at-rest-with-cmk.md?tabs=portal#configure-a-vault-to-encrypt-using-customer-managed-keys)
