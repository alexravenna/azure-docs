...
|---|---|---|
| 3.0.100 | Apr 2026 | - macOS min version supported: 13.0<br> - Always On Feature supported<br> - Feedback Prompts Feature<br> - Accessibility bug fixes<br> - SSO Phantom screen bug fixes |
